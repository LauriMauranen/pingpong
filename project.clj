(defproject pingpong "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "pingpong.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main pingpong.application
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                :figwheel {:on-jsload "pingpong.system/reset"}

                :compiler {:main cljs.user
                           :asset-path "js/compiled/out"
                           :output-to "dev-target/public/js/compiled/pingpong.js"
               ...
               {:id "test"
                ...
                :compiler {:output-to "dev-target/public/js/compiled/testable.js"
                           :main pingpong.test-runner
                           :optimizations :none}}

               {:id "min"
                :source-paths ["src/cljs" "src/cljc"]
                :jar true
                :compiler {:main pingpong.system
                           :output-to "resources/public/js/compiled/pingpong.js"
                           :output-dir "target"
                           :source-map-timestamp true
